            ...
            <article id="${produto.id}" itemscope>
                    ...
                    <div class="cabecalhoProduto-tituloEAutor">
                        <h1 itemprop="name" class="cabecalhoProduto-titulo">
                            ...
                            <span class="cabecalhoProduto-titulo-sub" role="presentation">
                                Aproveite toda a plataforma para construir aplicações
                            </span>
                        </h1>
                ...
                <section class="autoresDoLivro infoSection">
                    ...
                    <div class="autoresDoLivro-autor" itemprop="author" itemscope itemtype="http://schema.org/Person">
                        ...
                        <img class="autoresDoLivro-autor-foto" itemprop="image" src="//cdn.shopify.com/s/files/1/0155/7645/files/alberto-souza.png?1057931688501172147?v=2016-01-24" title="Foto de Alberto Souza"><!--
                ...
                <section class="comentariosDoLivro infoSection">
                    <h2 class="infoSection-titulo">
                        O que dizem deste livro
                    </h2>
                    <ul class="comentariosDoLivro-lista"><!--
                        ...
                        --><li class="comentariosDoLivro-lista-item">
                            <img class="comentariosDoLivro-lista-item-imagem" src="https://pbs.twimg.com/profile_images/378800000748939726/703f47e09a1c1683d44e230a097b7fa3_bigger.jpeg" /><!--
                            --><h3 class="comentariosDoLivro-lista-item-autor">
                                <a href="https://twitter.com/carlosync/status/684987804867260416" rel="nofollow" target="_blank" title="Ver comentário no twitter">Carlos Aur&#233;lio</a>
                                <a  class="comentariosDoLivro-lista-item-autor-twitter" href="http://www.twitter.com/carlosync" title="Ver autor no twitter">@carlosync</a>
                            </h3>
                            <p class="comentariosDoLivro-lista-item-comentario">
                        ...
                        --><li class="comentariosDoLivro-lista-quoteItem" role="presentation">
                            <img src="//cdn.shopify.com/s/files/1/0155/7645/t/189/assets/quotes.svg?1057931688501172147"
                                 alt="Quotes"
                                 role="presentation"
                                 >
                        </li><!--
